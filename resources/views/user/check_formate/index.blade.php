        ...
        <td>
          <table border="0" width="100%" cellspacing="0" cellpadding="5" style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5">
            <tr>
                  ...
                  <tr>
                    <td>
                      <span style="display: inline-block; vertical-align: top; font-size: 18px; line-height: 20px">
                        <span class="company name" style="font-size: 20px; font-weight: bold"> {{ $data['payor_name'] }}</span>
                        <br />
              ...
              <td style="text-align: right; width: 350px">
                <span style="font-size: 22px; font-weight: bold">{{ $data['check_number'] }}</span><br /><br /><span style="font-size: 16px"
                  >DATE: <span style="border-bottom: 1px solid #000; font-size: 22px">{{ $data['check_date'] }}</span>
                  <br />
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="5">
            <tr>
              ...
              <td style="width: 250px; background-color: #fff; vertical-align: middle; text-align: left; padding: 10px 10px; font-size: 24px;">$ {{ $data['amount'] }}</td>
            </tr>
          </table>
          <table border="0" width="100%" cellspacing="0" cellpadding="5" style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; line-height: 1.5">
            <tr>
              <td style="border-bottom: 1px solid black; padding: 20px 0 7px 5px; font-size: 22px; line-height: 25px; vertical-align: bottom; height: 45px">{{ $data['amount_word'] }}</td>
              ...
              <td style="font-size: 12px; padding: 10px; background-color: #fff; border-radius: 10px;height: 80px;">
                  @if (!empty($data['signature']))
                    <div style="text-align:center;">
                        <img width="100px" style="text-align:center; display:block; margin:0 auto;" src="{{ asset('sign/' . $data['signature']) }}"
                            alt="signature img" />
                    </div>       
                    @else
