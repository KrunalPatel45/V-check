    ...
    <style>
        * {
        ...
        @media (max-width: 700px) {
            ...
            .row-1 .column-1 .block-1.icons_block .icons-inner a,
            .row-1 .column-1 .block-1.icons_block .icons-inner td {
        ...
        @media (max-width:575px) {
            ...
            .row-1 .column-1 .block-1.icons_block .icons-inner a,
            .row-1 .column-1 .block-1.icons_block .icons-inner td,
            .row-1 .column-3 .block-1.icons_block .icons-inner a,
            .row-1 .column-3 .block-1.icons_block .icons-inner td {
                font-size: 14px !important;
            }

            .row-1 .column-1 .block-1.icons_block .icons-inner td img,
            .row-1 .column-3 .block-1.icons_block .icons-inner td img {
                width: 15px;
                height: 20px;
            }
            ...
            <tr>
                <td>
                    <table class="row row-1" align="center" width="100%" border="0" cellpadding="0"
                        ...
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f4fcff; background-size: auto">
                        <tbody>
                            <tr>
                                <td>
                                    <table role="presentation" align="center" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <div style="max-height:0; margin: 0 auto; text-align: center;">
                                                </div>
                                                <table class="row row-1" align="center" width="100%" border="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <table class="row-content" align="center" border="0"
                                                                    cellpadding="0" cellspacing="0" role="presentation"
                                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-image: url({{ asset('assets/banner.png') }}); background-repeat: no-repeat; background-size: cover; color: #000000; width: 680px; margin: 0 auto"
                                                                    width="680">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="column column-2" width="50%"
                                                                                style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-top: 10px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px">
                                                                                <table class="image_block block-1"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="pad"
                                                                                            style="padding-top: 0; width: 100%; padding-right: 0px; padding-left: 10px">
                                                                                            <div class="alignment"
                                                                                                align="left"
                                                                            ...
                                                                            <td class="column column-3" width="50%"
                                                                                style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-top: 25px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px">
                                                                                <table class="icons_block block-1"
                                                                                    width="100%" border="0"
                                                                                    cellpadding="0" cellspacing="0"
                                                                                    role="presentation"
                                                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; text-align: right">
                                                                                    <tr>
                                                                                        <td class="pad"
                                                                                            style="vertical-align: middle; color: #000; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size: 14px; font-weight: 500; padding-right: 10px; text-align: right">
                                                                                            <table width="100%"
                                                                                                cellpadding="0"
                                                                                                cellspacing="0"
                                                                                                role="presentation"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="alignment"
                                                                                                        ...
                                                                                                        <table
                                                                                                            class="icons-inner"
                                                                                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block; margin-left: -4px; padding-left: 0px; padding-right: 0px"
                                                                                                            cellpadding="0"
                                                                                                            cellspacing="0"
                                                                                                            role="presentation">
                                                                                                            <!--<![endif]-->
                                                                                                                ...
                                                                                                                <td class="header_icon"
                                                                                                                    ...
                                                                                                                    <a href="https://echecksystems.com/contact/"
                                                                                                                        ...
                                                                                                                        style="text-decoration: none"><img
                                                                                                                            class="icon"
                                                                                                                            alt="Contact"
                                                                                                                            src="{{ asset('assets/icons8-phone-50.png') }}"
                                                                                                                            height="auto"
                                                                                                                            width="20"
                                                                                                                            align="center"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="column column-2" width="100%"
                                                                                style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;font-weight: 400;text-align: left;padding-top: 0;vertical-align: top;border-top: 0px;border-right: 0px;border-bottom: 0px;border-left: 0px"
                                                                                colspan="3">
                                                                                <table class="image_block block-1"
                                                                                    width="100%" border="0"
                                                                                    cellpadding="0" cellspacing="0"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="pad"
                                                                                                style="padding-top: 0;width: 100%;padding-right: 0px;padding-left: 0px">
                                                                                                <div class="alignment client-login"
                                                                                                    align="center"
                                                                                                    style="padding: 20px 14px 0 14px; margin: 0px 20px 0;background: #fff;border-top-left-radius: 10px;border-top-right-radius: 10px;">
                                                                                                    <div
                                                                                                        style="max-width: 615px; padding: 0 5px;">
                                                                                                        <h1
                                                                                                            style="margin: 0 auto; color: #101112; font-size: 16px; font-weight: bold; letter-spacing: 0px; line-height: 120%; text-align:left; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                                                                                                            {{ $emailContent->head }}
                                                                                                        </h1>
                                                                                                    </div>
                                                ...
                                                <!-- TEXT BLOCK START -->
                                                <table class="row row-2 login-detail" align="center" width="100%"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <table class="row-content stack client-row-content"
                                                                    align="center" border="0" cellpadding="0"
                                                                    cellspacing="0" role="presentation"
                                                                    style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;background-color: #fff;background-image: url('');background-repeat: no-repeat;background-size: auto; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; color: #000000;width: 640px;margin: 0 auto; overflow: hidden;"
                                                                    width="680">
                                                                    <tbody>
                                                                        <tr>
                                    ...
                                    ">
                                                                                                    <p
                                                                                                        style="margin: 0">
                                                                                                        <strong>{{ $emailContent->content }}</strong>
                                                                                                    </p>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                    ...
                                    ">
                                                                                ...
                                                                                <table class="paragraph_block block-6"
                                                                                    width="100%" border="0"
                                                                                    cellpadding="0" cellspacing="0"
                                                                                    role="presentation"
                                                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word">
...
<!
                                    ...
                                    <table class="row row-3" align="center" width="100%" border="0"
                                        cellpadding="0" cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f4fcff">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="column column-1" width="100%"
                                                                    ...
                                                                    <table class="divider_block block-1"
                                                                        width="100%" border="0"
                                                                                    ...
                                                                                    <table border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="divider_inner"
                                                                                                style="font-size: 1px; line-height: 1px; border-top: 1px solid #003380">
                                                                                                <span>&#8202;</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <table class="row-content stack" align="center" border="0"
                                                        cellpadding="0" cellspacing="0" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #1088B6; color: #000000; width: 680px; margin: 0 auto"
                                                        width="680">
                                                        <tbody>
                                                            <tr>
                                                                <td class="column column-1" width="100%"
                                    ...
                                    <table class="row row-6" align="center" width="100%" border="0"
                                        cellpadding="0" cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f4fcff">
                                        <tbody>
                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="column column-1"
                                                                    ...
                                                                    <table class="icons_block block-1" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td class="pad"
                                                                                style="vertical-align: middle; color: #fff; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size: 14px; font-weight: 600; text-align: center">
                                                                                        ...
                                                                                        <td class="alignment"
                                                                                            ...
                                                                                            <table class="icons-inner"
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size: 14px; font-weight: 600; color: #fff; vertical-align: middle; letter-spacing: undefined; text-align: center">
                                                                                                        Contact US
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                            ...
                                                                                            <table class="icons-inner"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td
                                                                                                        style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 5px">
                                                                                                        <img class="icon"
                                                                                                            src="{{ asset('assets/icons8-email-50.png') }}"
                                                                                                            height="auto"
                                                                                                            width="16"
                                                                                                            align="center"
                                                                                                            style="display: block; height: auto; margin: 0 auto; border: 0" />
                                                                                            ...
                                                                                            <table class="icons-inner"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td
                                                                                                        style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 5px">
                                                                                                        <img class="icon"
                                                                                                            src="{{ asset('assets/icons8-website-50.png') }}"
                                                                                                            height="auto"
                                                                                                            width="16"
                                                                                                            align="center"
                                                                                                            style="display: block; height: auto; margin: 0 auto; border: 0" />
                                                    ...
                                                    <table class="row-content stack" align="center" border="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="column column-1" width="100%"
                                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px">
                                                                    <table class="social_block block-1" width="100%"
                                                                        border="0" cellpadding="0"
                                                                        cellspacing="0" role="presentation"
                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt">
                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td
                                                                                                ...
                                                                                                <a href="https://www.facebook.com"
                                                                                                    target="_blank"><img
                                                                                                        src="{{ asset('assets/facebook2x.png') }}"
                                                                                                        width="32"
                                                                                                        height="auto"
                                                                                                        alt="Facebook"
                                                                                                        title="facebook"
                                                                                            ...
                                                                                            <td
                                                                                                ...
                                                                                                <a href="https://www.twitter.com"
                                                                                                    target="_blank"><img
                                                                                                        src="{{ asset('assets/twitter2x.png') }}"
                                                                                                        width="32"
                                                                                                        height="auto"
                                                                                                        alt="Twitter"
                                                                                                        title="twitter"
                                                                                            ...
                                                                                            <td
                                                                                                ...
                                                                                                <a href="https://www.linkedin.com"
                                                                                                    target="_blank"><img
                                                                                                        src="{{ asset('assets/linkedin2x.png') }}"
                                                                                                        width="32"
                                                                                                        height="auto"
                                                                                                        alt="Linkedin"
                                                                                                        title="linkedin"
                                                                                            ...
                                                                                            <td
                                                                                                ...
                                                                                                <a href="https://www.instagram.com"
                                                                                                    target="_blank"><img
                                                                                                        src="{{ asset('assets/instagram2x.png') }}"
                                                                                                        width="32"
                                                                                                        height="auto"
                                                                                                        alt="Instagram"
                                                                                                        title="instagram"
                                    ...
                                    ">
                                                                                    <p style="margin: 0">
                                                                                        ...
                                                                                        financial, legal, or
                                                                                        professional advice. Users are
                                                                                        responsible for ensuring
                                                                                        compliance with applicable laws
                                                                                        and regulations. Services may
                                    ...
                                    <table class="row row-9" align="center" width="100%" border="0"
                                        cellpadding="0" cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f4fcff">
                                        <tbody>
                                            <tr>
