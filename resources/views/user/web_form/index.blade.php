                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="rp_page" name="rp_page" class="form-control form-select">
                                            <option value="10" {{ config('app.rp_per_page') == 10 ? 'selected' : '' }}>
                                                10</option>
                                            <option value="20" {{ config('app.rp_per_page') == 20 ? 'selected' : '' }}>
                                                20</option>
                                            <option value="30" {{ config('app.rp_per_page') == 30 ? 'selected' : '' }}>
                                                30</option>
                                            <option value="40" {{ config('app.rp_per_page') == 40 ? 'selected' : '' }}>
                                                40</option>
                                            <option value="50" {{ config('app.rp_per_page') == 50 ? 'selected' : '' }}>
                                                50</option>
                                            <option value="100" {{ config('app.rp_per_page') == 100 ? 'selected' : '' }}>
                                                100</option>
                                        </select>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="sp_page" name="sp_page" class="form-control form-select">
                                            <option value="10" {{ config('app.sp_per_page') == 10 ? 'selected' : '' }}>
                                                10</option>
                                            <option value="20" {{ config('app.sp_per_page') == 20 ? 'selected' : '' }}>
                                                20</option>
                                            <option value="30" {{ config('app.sp_per_page') == 30 ? 'selected' : '' }}>
                                                30</option>
                                            <option value="40" {{ config('app.sp_per_page') == 40 ? 'selected' : '' }}>
                                                40</option>
                                            <option value="50" {{ config('app.sp_per_page') == 50 ? 'selected' : '' }}>
                                                50</option>
                                            <option value="100"
