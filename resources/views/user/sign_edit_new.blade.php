...
<script>
    ...
    document.getElementById('confirmSaveBtn').addEventListener('click', function() {
        ...
        .then(data => {
            if (data.success) {
                $('#currentSignature').attr('src', dataUrl);
    ...
    <div class="card-body">
        <div class="row">
            <div class="col d-flex gap-5">
                ...
                <img id="currentSignature" width="350" height="100" src="{{ !empty($userSignature->Sign) ? asset('sign/' . $userSignature->Sign) : ''}}" />
            </div>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
          <div class="row" style="margin-top : 20px; ">
            <div class="col-8">
                <input type="text" id="nameInput" class="form-control" value="{{ $userSignature->Name }}" placeholder="Enter your name" autocomplete="off">
            </div>
            <div class="col-4">
