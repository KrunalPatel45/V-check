...
@section('content')
    <div class="row">
        <form action="{{ route('user.payee.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Basic Layout -->
            <div class="col-xxl">
                <div class="card mb-6">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Payee</h5>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-sm-10">
                                <select id="category" name="category" class="form-control form-select">
                                    <option value="RP" {{ old('category') == 'RP' ? 'selected' : '' }}>Payment recive
                                        check genration
                                    </option>
                                    <option value="SP" {{ old('category') == 'SP' ? 'selected' : '' }}>Payment send
                                        check genration
                                    </option>
                                </select>
                        ...
                        {{-- <div class="row mb-6">
                            ...
                            <div class="col-sm-10 p-6">
                                <label class="switch switch-square" for="same_as">
                                    ...
                                    <span class="switch-label">Same As Vendor</span>
                                </label>
                            </div>
                        </div> --}}
                    </div>
