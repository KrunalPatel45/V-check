...
<body>
    <div class="container py-5">
        ...
        <div class="row mt-5">
            <div class="col">
                <b>{{ $subscription['customer']['name'] }}</b> on {{ $subscription['product']['name'] }}
                ...
                <table class="table table-bordered" style="font-size:14px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $subscription['next_invoice_at'] }}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>${{ number_format($subscription['invoice']['lines']['data'][0]['amount'] / 100, 2) }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
